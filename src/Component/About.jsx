    ...
    <section id="about" className="py-20 bg-gray-900 text-white px-6">
      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex-shrink-0">
          <img
            src="https://avatars.githubusercontent.com/u/000000?v=4" // replace with your photo or avatar
        ...
        <div className="bg-gray-800 p-6 rounded-xl shadow-lg w-full">
          <p className="text-gray-300 mb-4">
            ...
            <span className="text-teal-400"> Full Stack Developer</span> and CSE student.  
            I love building modern web & mobile apps and solving real-world problems with code.
          </p>
          <ul className="list-disc list-inside text-gray-400 space-y-2">
            <li>B.Tech CSE @ KCC ITM</li>
            <li>Strong in Web Dev, App Dev, Problem Solving</li>
